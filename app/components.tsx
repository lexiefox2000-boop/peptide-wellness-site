    ...
    <section className="section">
      <div className="container grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr]">
        <div className="fade-up">
          ...
          <h1 className="mt-4 max-w-3xl text-5xl font-semibold tracking-tight md:text-7xl">Modern Peptide Wellness Without Membership Fees</h1>
          <p className="mt-6 max-w-2xl text-lg text-[var(--muted)]">Built to feel premium and medically adjacent without subscription friction, hidden pricing, or forced commitments. Learn first, shop clearly, and check out fast.</p>
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-sm text-[var(--muted)]">
            <span className="rounded-full bg-white px-4 py-2">One-time purchases</span>
        ...
        <div className="gradient-ring card rounded-[2rem] p-6">
          <div className="rounded-[1.5rem] bg-[var(--surface-soft)] p-5">
            ...
            <div className="mt-5 rounded-[1.5rem] bg-white p-6">
              ...
              <p className="mt-3 text-sm text-[var(--muted)]">Education-forward product presentation with usage notes, transparent fulfillment details, and guest checkout.</p>
              <div className="mt-5 flex items-center gap-3 text-sm">
                <span className="rounded-full bg-[var(--accent)] px-3 py-2 text-[var(--primary)]">No subscription</span>
    ...
    <section className="section border-y border-black/5 bg-white/70">
      <div className="container grid gap-8 lg:grid-cols-2">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">A cleaner educational layer before the product pitch</h2>
        </div>
        <div className="space-y-4 text-[var(--muted)]">
          ...
          <p>That keeps the experience trustworthy and compliant: users can understand what they are shopping for without exaggerated claims, surprise fees, or confusing membership funnels.</p>
        </div>
      </div>
    </section>
  );
      ...
      <div className="container">
        <div className="flex items-end justify-between gap-6">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">Transparent cards built to convert</h2>
          </div>
...
export function HowItWorks() {
  const steps = [
    ...
    ['Choose', 'Select a one-time purchase with no required membership and a fast, mobile-friendly cart flow.'],
  ...
  return (
    <section className="section bg-white/70 border-y border-black/5">
      <div className="container">
        ...
        <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">Three steps, no subscription maze</h2>
        <div className="mt-8 grid gap-6 md:grid-cols-3">
...
export function BenefitsTrust() {
  const items = [
    ['Transparent pricing', 'No membership gates between the user and the actual product price.'],
    ['Clear product labeling', 'Dosage, contents, storage notes, and fulfillment context are shown in plain language.'],
    ['Trust-first UX', 'Educational content and FAQs answer concerns before payment details appear.'],
    ...
    <section className="section">
      <div className="container grid gap-8 lg:grid-cols-[1fr_1.1fr]">
        <div>
          ...
          <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">Premium without pressure</h2>
    ...
    <section className="section">
      <div className="container">
        <div className="card rounded-[2rem] bg-[linear-gradient(135deg,#ffffff,#eef4f2)] p-8 md:p-12">
          ...
          <h2 className="mt-3 max-w-3xl text-3xl font-semibold tracking-tight md:text-5xl">A direct-to-consumer peptide brand that feels simpler, clearer, and easier to trust</h2>
          <p className="mt-4 max-w-2xl text-[var(--muted)]">Use this foundation to launch a conversion-focused ecommerce experience with premium design language, no forced memberships, and educational messaging that supports compliance review.</p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
